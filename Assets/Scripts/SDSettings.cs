...
class SDParamsInTxt2Img
{
    ...
    public Dictionary<string, object> alwayson_scripts = new Dictionary<string, object>{{"LayerDiffuse", new LayerDiffuse()}};
}
...
//              {"layerdiffusion_save",true},
//              {"layerdiffusion_method ","(SDXL) Only Generate Transparent Image (Attention Injection)"},
//              {"layerdiffusion_weight",1},
//              {"layerdiffusion_ending_step",1},
//              {"layerdiffusion_fg_image", null},
//              {"layerdiffusion_bg_image", null},
//             {"layerdiffusion_blend_image", null},
